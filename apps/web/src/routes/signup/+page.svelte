...
>
	<div class="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-xl dark:bg-gray-800">
		<div>
			...
			<p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Sign up with your invite code</p>
		</div>
		...
		<form onsubmit={handleSubmit} class="space-y-6">
			...
			<div>
				...
				<input
					...
					required
					disabled={isLoading}
					class="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-3 uppercase focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 disabled:opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
				/>
				<p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
